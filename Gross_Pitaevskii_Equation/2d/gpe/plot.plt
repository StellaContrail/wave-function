...
do for [i=0: data_num-1] {
    ...
    if (isdebug == 0) {
        set multiplot layout 2,2 scale 1,1
            ...
            splot "wavefunction_imaginary_final.txt" using 1:2:4 title "" with pm3d
            ...
            splot "wavefunction_real_time_development.txt" using 1:2:3 every :::M*i::M*(i+1)-1 title "" with pm3d
            #unset contour
            #set surface
            ...
            splot "wavefunction_imaginary_final.txt" using 1:2:3 title "" with pm3d

            unset zrange
            unset cbrange
            set title sprintf("External Potential")
            splot "potential_imaginary.txt" using 1:2:4 every :::M*i::M*(i+1)-1 title "" with pm3d
        unset multiplot
    } else {
        set zrange  [0:1]
        set cbrange [0:1]
