...
do for [i=0: data_num-1] {
    ...
    splot "wavefunction_real_time_development.txt" using 1:2:3 every :::M*i::M*(i+1)-1 title "", "probability_current_real_time_development.txt" using 1:2:(0):($3*15):($4*15):(0) every :::M*i::M*(i+1)-1 title "" with vectors linecolor rgb "#000000"
    unset pm3d
